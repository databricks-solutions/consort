...
async function cutExperiment(args, deps = {}) {
  ...
  try {
    const corpusPaths = [
      ...
      join2(projectDir, "client", "src", "styles", "theme.css"),
      join2(projectDir, "client", "src", "styles", "global.css")
...
`
  ...
  writeFileSync2(join2(dir, "outcomes.json"), JSON.stringify(outcomes, null, 2) + "\n");
  writeFileSync2(
    join2(dir, "timeline.json"),
    JSON.stringify(
