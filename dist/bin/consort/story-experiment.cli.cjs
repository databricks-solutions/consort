...
function gitIsAncestor(cwd, ancestor, descendant) {
  try {
    (0, import_node_child_process.execFileSync)("git", ["merge-base", "--is-ancestor", ancestor, descendant], {
      cwd,
...
function gitRevParse(cwd, ref) {
  try {
    return (0, import_node_child_process.execFileSync)("git", ["rev-parse", "--verify", "--quiet", ref], {
      cwd,
      encoding: "utf8",
...
async function cutExperiment(args, deps = {}) {
  ...
  try {
    const corpusPaths = [
      ...
      (0, import_path.join)(projectDir, "client", "src", "styles", "theme.css"),
      (0, import_path.join)(projectDir, "client", "src", "styles", "global.css")
...
function mirrorToRecordDir(text) {
  ...
  try {
    ...
    (0, import_fs3.mkdirSync)((0, import_path5.dirname)(dst), { recursive: true });
...
var realExperimentOps = {
  ...
  runMigrations: async ({ instance, branch, projectDir }) => {
    await (0, import_lakebase9.applySchemaMigrations)({ instance, branch, projectDir });
  },
...
function storyDesignFingerprint(consortDir, feature, story) {
  try {
    const raw = (0, import_node_fs7.readFileSync)(storyTestListJson(consortDir, feature, story), "utf8");
...
function validateExperimentArgs(args) {
