...
init_esm_shims();
import { existsSync as existsSync2, readFileSync as readFileSync2, writeFileSync as writeFileSync2, mkdirSync as mkdirSync2, readdirSync as readdirSync2 } from "fs";
...
function evaluateStoryCanon(sftddDir2, featureId, story) {
  ...
  if (existsSync2(archFile)) {
    try {
      archContent = readFileSync2(archFile, "utf8");
    } catch {
      archContent = void 0;
    }
  }
...
function projectStoryNotes(sftddDir2, featureId, story) {
  ...
  for (const acId of storyAcIds(sftddDir2, featureId, story)) {
    ...
    let ac;
    try {
      ac = JSON.parse(readFileSync2(file, "utf8"));
    } catch {
      continue;
    }
    ...
    writeFileSync2(file, JSON.stringify(ac, null, 2) + "\n");
    annotated++;
  }
  return annotated;
}
...
`);
process.exit(0);
//# sourceMappingURL=project-canon-notes.cli.js.map